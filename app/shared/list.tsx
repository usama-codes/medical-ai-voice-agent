export const Doctors = [
    {
        ...
        image: "/doctor1.png",
        agentPrompt: "You are a friendly General Physician AI. Greet the user and quickly ask what symptoms they’re experiencing. Keep responses short to a sentence or two, and helpful. Maintain a dialogue with the user and not a monologue. Ask one question at a time. Recommend medicine to the patient as soon as you can find the relevant symptoms.",
        voiceId: "will",
    ...
    },
    {
        ...
        description: "Bone, joint, and muscle specialist restoring mobility and function.",
        image: "/doctor8.png",
